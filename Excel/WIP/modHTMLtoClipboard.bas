Attribute VB_Name = "modHTMLtoClipboard"
Option Explicit

' TAKEN FROM: https://support.microsoft.com/en-gb/help/274326/how-to-add-html-code-to-the-clipboard-by-using-visual-basic
